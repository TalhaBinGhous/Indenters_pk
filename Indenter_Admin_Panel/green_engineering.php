...
<main id="main" class="main">
  ...
  <div class="container">
    <div class="row">
      ...
      ?>
      <div class="col-lg-6 col-md-6 mb-4"> <!-- Updated to col-lg-6 -->
        <div class="card">
          <img src="<?php echo "green_engineering/" . $row["image"]?>" class="card-img-top" alt="Image description">
          <div class="card-body text-center" >
            <h5 class="card-title"><?php echo $row['name']?></h5>
            <p class="card-text"><?php echo $row['description']?></p>
            <!-- Update Button -->
            <a href="update_engineering_products.php?id=<?php echo $row['id'];?>" style="background-color: #4CAF50; color: white; padding: 10px 20px; 
                        text-align: center; text-decoration: none; display: inline-block; 
                        border-radius: 5px; margin-right: 10px;">Update</a>
            <!-- Delete Button -->
            <a href="delete_engineering_products.php?id=<?php echo $row['id']; ?>" class="delete-button" 
